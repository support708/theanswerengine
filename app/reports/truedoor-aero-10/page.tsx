      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center px-6 py-20 bg-[#131313]">
        ...
        <div className="relative z-10 max-w-4xl text-center">
          ...
          <h1 className="font-headline font-black text-7xl md:text-8xl tracking-tighter uppercase mb-6 leading-none">
            Make More <span className="text-[#FF6A00]">Money</span> <br /> With Less{' '}
            <span className="text-[#FF6A00]">Chaos</span>
          </h1>
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <div className="border-l-4 border-[#FF6A00] pl-4 py-2">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            ...
            <h2 className="font-headline font-black text-6xl tracking-tighter uppercase mt-4">
              The <span className="text-[#FF6A00]">Playbook</span> is Clear
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Finding 1 */}
            <div className="bg-[#2a2a2a] border border-white/10 p-6 hover:border-[#FF6A00]/30 transition-colors">
              <div className="font-mono text-xs uppercase tracking-widest text-[#FF6A00] mb-3">Finding 01</div>
            ...
            {/* Finding 2 */}
            <div className="bg-[#2a2a2a] border border-white/10 p-6 hover:border-[#FF6A00]/30 transition-colors">
              <div className="font-mono text-xs uppercase tracking-widest text-[#FF6A00] mb-3">Finding 02</div>
            ...
            {/* Finding 3 */}
            <div className="bg-[#2a2a2a] border border-white/10 p-6 hover:border-[#FF6A00]/30 transition-colors">
              <div className="font-mono text-xs uppercase tracking-widest text-[#FF6A00] mb-3">Finding 03</div>
            ...
            {/* Finding 4 */}
            <div className="bg-[#2a2a2a] border border-white/10 p-6 hover:border-[#FF6A00]/30 transition-colors">
              <div className="font-mono text-xs uppercase tracking-widest text-[#FF6A00] mb-3">Finding 04</div>
            ...
            {/* Finding 5 */}
            <div className="bg-[#2a2a2a] border border-white/10 p-6 hover:border-[#FF6A00]/30 transition-colors">
              <div className="font-mono text-xs uppercase tracking-widest text-[#FF6A00] mb-3">Finding 05</div>
            ...
            {/* Finding 6 - bonus */}
            <div className="bg-[#2a2a2a] border border-white/10 p-6 hover:border-[#FF6A00]/30 transition-colors">
              <div className="font-mono text-xs uppercase tracking-widest text-[#FF6A00] mb-3">Finding 06</div>
      ...
      <section className="-mx-6 px-6 py-20 bg-[#131313] border-t border-white/10">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            ...
            <h2 className="font-headline font-black text-6xl tracking-tighter uppercase mt-4">
              Why This <span className="text-[#FF6A00]">Matters</span> Now
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-[#1c1b1b] border border-white/10 p-6 text-center">
              <div className="font-mono text-xs uppercase tracking-widest text-[#FF6A00] mb-3">Vacancy</div>
              <div className="text-5xl font-black mb-2">4.0%</div>
              <p className="text-[#b0a89f] text-sm">OC multifamily — near zero slack</p>
            </div>
            <div className="bg-[#1c1b1b] border border-white/10 p-6 text-center">
              <div className="font-mono text-xs uppercase tracking-widest text-[#FF6A00] mb-3">Rent / Month</div>
              <div className="text-5xl font-black mb-2">$4,475</div>
              <p className="text-[#b0a89f] text-sm">Irvine median (all types, Feb 2026)</p>
            </div>
            <div className="bg-[#1c1b1b] border border-white/10 p-6 text-center">
              <div className="font-mono text-xs uppercase tracking-widest text-[#FF6A00] mb-3">Turnover Cost</div>
          ...
          <div className="bg-[#1c1b1b] border border-white/10 p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h4 className="text-[#FF6A00] font-black text-sm uppercase mb-3">Good Life PM (Market Leader)</h4>
              ...
              <div>
                <h4 className="text-[#FF6A00] font-black text-sm uppercase mb-3">TrueDoor (Current State)</h4>
                <ul className="text-sm text-[#b0a89f] space-y-2">
          ...
          <div className="border-l-4 border-[#FF6A00] pl-6 py-4">
      ...
      <section className="-mx-6 px-6 py-20 bg-[#1c1b1b] border-t border-white/10">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            ...
            <h2 className="font-headline font-black text-6xl tracking-tighter uppercase mt-4">
              The <span className="text-[#FF6A00]">Pain</span> Stack
            </h2>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#131313] border border-white/10 p-8">
              <div className="flex items-start gap-6">
                <div className="flex-shrink-0 text-4xl font-black text-[#FF6A00] opacity-20">01</div>
                <div>
            ...
            <div className="bg-[#131313] border border-white/10 p-8">
              <div className="flex items-start gap-6">
                <div className="flex-shrink-0 text-4xl font-black text-[#FF6A00] opacity-20">02</div>
                <div>
            ...
            <div className="bg-[#131313] border border-white/10 p-8">
              <div className="flex items-start gap-6">
                <div className="flex-shrink-0 text-4xl font-black text-[#FF6A00] opacity-20">03</div>
                <div>
            ...
            <div className="bg-[#131313] border border-white/10 p-8">
              <div className="flex items-start gap-6">
                <div className="flex-shrink-0 text-4xl font-black text-[#FF6A00] opacity-20">04</div>
                <div>
          ...
          <div className="mt-8 border-l-4 border-[#FF6A00] pl-6 py-4 bg-[#131313]/50">
      ...
      <section className="-mx-6 px-6 py-20 bg-[#131313] border-t border-white/10">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            ...
            <h2 className="font-headline font-black text-6xl tracking-tighter uppercase mt-4">
              Where TrueDoor Is <span className="text-[#FF6A00]">Vulnerable</span>
            </h2>
          </div>

          <div className="space-y-6 mb-12">
            {/* Gap 1 */}
            <div className="bg-[#1c1b1b] border-l-4 border-[#FF6A00] p-6">
          ...
          <div className="bg-[#FF6A00] text-[#131313] p-8 rounded-none">
      ...
      <section className="-mx-6 px-6 py-20 bg-[#1c1b1b] border-t border-white/10">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            ...
            <h2 className="font-headline font-black text-6xl tracking-tighter uppercase mt-4">
              How AI-First <span className="text-[#FF6A00]">Content</span> Changes the Game
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {/* A */}
            <div className="bg-[#131313] border border-white/10 p-8">
              <div className="font-mono text-xs uppercase tracking-widest text-[#FF6A00] mb-4">A — AI Research</div>
            ...
            {/* E */}
            <div className="bg-[#131313] border border-white/10 p-8">
              <div className="font-mono text-xs uppercase tracking-widest text-[#FF6A00] mb-4">E — Expert Integration</div>
            ...
            {/* R */}
            <div className="bg-[#131313] border border-white/10 p-8">
              <div className="font-mono text-xs uppercase tracking-widest text-[#FF6A00] mb-4">R — Rapid Iteration</div>
            ...
            {/* O */}
            <div className="bg-[#131313] border border-white/10 p-8">
              <div className="font-mono text-xs uppercase tracking-widest text-[#FF6A00] mb-4">O — Owned Assets</div>
      ...
      <section className="-mx-6 px-6 py-20 bg-[#131313] border-t border-white/10">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            ...
            <h2 className="font-headline font-black text-6xl tracking-tighter uppercase mt-4">
              The <span className="text-[#FF6A00]">90-Day</span> Sprint
            </h2>
          </div>
          ...
          <div className="space-y-4 mb-12">
            <div className="bg-[#1c1b1b] border-l-4 border-[#FF6A00] p-6">
              <div className="flex items-baseline gap-3">
                <span className="font-headline font-black text-3xl text-[#FF6A00]">Q1</span>
            ...
            <div className="bg-[#1c1b1b] border-l-4 border-[#FF6A00] p-6">
              <div className="flex items-baseline gap-3">
                <span className="font-headline font-black text-3xl text-[#FF6A00]">Q2</span>
            ...
            <div className="bg-[#1c1b1b] border-l-4 border-[#FF6A00] p-6">
              <div className="flex items-baseline gap-3">
                <span className="font-headline font-black text-3xl text-[#FF6A00]">Q3</span>
          ...
          <div className="mb-12 bg-[#FF6A00] text-[#131313] p-8">
          ...
          {/* CTA Block */}
          <div className="bg-[#FF6A00] text-[#131313] p-12 text-center rounded-none">
            ...
            <a
              ...
              className="inline-block bg-[#131313] text-[#FF6A00] font-headline font-black text-lg uppercase px-8 py-4 hover:bg-[#2a2a2a] transition-colors"
            >
              Schedule Call
            </a>
          </div>
