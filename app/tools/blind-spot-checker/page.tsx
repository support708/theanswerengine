...
const PREVIEW_RESULTS = [
  {
    ...
    response: (
      <>
        ...
        <span className="text-[#F27D24] font-bold underline">
          Competitor A
        </span>{' '}
      ...
      <main className="pt-32 pb-24 px-6 max-w-7xl mx-auto relative z-20">
        ...
        <section className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            <div className="lg:col-span-8">
              {/* Tag */}
              <div className="inline-block px-3 py-1 bg-[#353534] text-[#F27D24] font-mono text-[10px] tracking-widest mb-6 uppercase">
              ...
              <h1 className="font-headline font-black text-5xl md:text-7xl uppercase tracking-tighter leading-[0.9] mb-8">
                ...
                <span className="text-[#F27D24]">COMPETITORS</span> INSTEAD OF
                YOU?
              </h1>
            ...
            <div className="lg:col-span-4 flex justify-end">
              <div className="w-full aspect-square bg-[#1c1b1b] border border-white/10 p-4 relative overflow-hidden hidden lg:block">
                <div
                  ...
                  style={{
                    background:
                      'radial-gradient(#F27D24 1px, transparent 1px)',
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span
                    className="font-mono text-[#F27D24] text-8xl font-black opacity-30 select-none"
                    aria-hidden="true"
                  >
                    AI_
                  </span>
                </div>
                <div className="absolute bottom-4 right-4 font-mono text-[10px] text-[#F27D24] tracking-tighter uppercase">
          ...
          <div className="order-2 lg:order-1">
            ...
            >
              <div className="flex justify-between items-center mb-8 border-b border-white/10 pb-4">
                ...
                <span className="text-[#F27D24] font-mono text-sm">[SCAN]</span>
              </div>
              ...
              <form className="space-y-6" action="/tools/blind-spot-checker" method="GET">
                ...
                <button
                  type="submit"
                  className="w-full bg-[#F27D24] text-black font-headline font-black py-4 px-8 uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-white transition-colors text-lg"
                  style={{ boxShadow: '4px 4px 0px 0px #000000' }}
                >
                  Run My Free Scan
        ...
        <section className="mb-32">
          <div className="mb-12">
            ...
            <div className="h-1 w-24 bg-[#F27D24]" />
          </div>
        ...
        {/* ── CTA ──────────────────────────────────────────────────────────── */}
        <section
          className="relative bg-[#F27D24] p-12 lg:p-20 overflow-hidden"
          style={{ boxShadow: '4px 4px 0px 0px #000000' }}
        >
          {/* Background text */}
          <div
