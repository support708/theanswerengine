      ...
      <main className="min-h-screen bg-[#0F1117]">
        ...
        <article className="max-w-4xl mx-auto px-6 py-12 sm:py-16">
          <div className="prose prose-invert prose-lg max-w-none prose-headings:font-plus-jakarta prose-headings:text-white prose-p:text-gray-300 prose-a:text-[#FF6A00] prose-a:no-underline hover:prose-a:underline prose-strong:text-white">
            ...
            <p>Some content categories are best attributed to an organizational author rather than an individual: research reports, industry benchmarks, and policy positions, for example. When organizational authorship is the right choice, the Expertise signal depends on the organization&rsquo;s own credibility indicators: how long it has been operating, whether its research has been cited by other publications, and whether named individual experts are identified elsewhere on the site as contributors to the research. Pure anonymous brand authorship — content that has neither a named individual nor a credentialed organization behind it — is the weakest possible Expertise signal in the 2026 trust stack.</p>

            {/* CTA 4 */}
            <div className="ae-cta-inline not-prose">
              <p>Our team can audit every page on your site for Expertise signals and produce a prioritized implementation plan for bylines and Person schema. Call or email to set up the review.</p>
            ...
            <p>Authoritativeness is built off the brand&rsquo;s own domain. It is the aggregate of how many independent, authoritative sources reference the brand and its content across the open web — the off-page citation graph that tells AI platforms whether the brand is recognized by its category peers or exists only as a self-declared authority. Every company with zero AI citations shares one structural trait: an off-page presence that either does not exist or is dominated by competitor signals on the same third-party platforms.</p>

            <div className="ae-quote not-prose">
              <p><strong className="ae-named-thesis">The Off-Page Footprint:</strong> every company with zero AI citations shares one structural trait — an off-page presence that either does not exist or is dominated by competitor signals on the same third-party platforms (AirOps, 2026).</p>
            </div>

            <p>The mechanism is direct. When an AI system evaluates whether your brand is an authoritative source on a topic, the evaluation includes signals from outside your domain: how many independent publishers have cited your content, whether your brand appears in structured review platforms that aggregate social proof, and whether community platforms show unprompted mentions from users who engaged with your product or content. Brands that have invested only in their own-domain content have no off-page authority layer — and AI systems treat that absence as evidence against authority.</p>

            <h3>The Earned Media Premium</h3>

            <div className="ae-quote not-prose">
              <p><strong className="ae-named-thesis">The Earned Media Premium:</strong> content cited by independent publishers earns 5x more AI citations than identical content published only on the source brand&rsquo;s own domain (Muck Rack, May 2026).</p>
            </div>

            <p>Earned media drives 84% of AI citations across major platforms (Muck Rack, May 2026). Distributing identical content across multiple independent publications produces up to 325% more AI citations than keeping that content exclusively on the brand&rsquo;s own domain. The mechanism is authority inheritance: when an independent publisher cites or republishes your content, the AI system registers the citation as evidence that an external authority has validated the content&rsquo;s accuracy and relevance. <strong className="ae-named-thesis">Authority Inheritance</strong> — when a brand inherits credibility from the publishers that cite it — compounds over time: each new earned citation strengthens the brand&rsquo;s position in the authority graph and makes future citations more likely.</p>
