      ...
      <main className="min-h-screen bg-[#0F1117]">
        ...
        <article className="max-w-4xl mx-auto px-6 py-12 sm:py-16">
          ...
          <div className="prose prose-invert prose-lg max-w-none prose-headings:font-plus-jakarta prose-headings:text-white prose-p:text-gray-300 prose-a:text-[#FF6A00] prose-a:no-underline hover:prose-a:underline prose-strong:text-white">
            ...
            <p>Testimonials are among the most persuasive content on any coaching website and among the most invisible to AI citation systems. The gap exists because most coaching practices publish testimonials in one of three forms that AI systems cannot read: image quote graphics with the client name and photo, PDF downloads of written testimonials, or video testimonials without text transcripts. In all three cases, the social proof that would strengthen an AI&rsquo;s confidence in citing the practitioner is hidden inside a format that AI crawlers process as an opaque asset rather than readable content. <a href="https://calendly.com/theanswerengine-support/30min" className="cta-inline">Book your free consultation here.</a></p>
          ...
          <div className="not-prose my-16 p-8 rounded-2xl bg-gradient-to-br from-[#FF6A00]/10 to-transparent border border-[#FF6A00]/20">
            ...
            <p className="text-gray-400 mb-6">Get a free Blind Spot Report showing whether ChatGPT, Perplexity, Claude, or Google AI is currently citing your practice for queries in your specialty, which competitors are capturing those citations instead, and exactly which signals on your site are blocking you from appearing. <a href="https://theanswerengine.ai/blindspot" className="cta-inline">Run your free AI Blind Spot Scan.</a></p>
