      ...
      <article className="max-w-4xl mx-auto px-6 py-8">
        ...
        <section className="mt-12">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Link href="/blog/why-ai-says-wrong-things-about-business" className="block p-4 rounded-xl border border-white/10 bg-white/5 hover:border-[#FF6A00]/30 transition-colors">
        ...
        <div className="ae-author-card">
          ...
          <div>
            ...
            <div className="text-gray-400 text-sm">We help businesses understand and improve how AI represents them. Our analysis covers every signal AI uses to build confidence about a business and every gap that keeps businesses below the recommendation threshold.</div>
          </div>
        </div>
