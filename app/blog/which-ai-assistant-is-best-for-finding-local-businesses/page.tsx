      ...
      <main className="max-w-4xl mx-auto px-6 py-20" style={{ backgroundColor: '#0F1117', minHeight: '100vh' }}>
        ...
        >
          ...
          >
            ...
            <circle cx="480" cy="200" r="70" stroke="#F27D24" strokeWidth="0.8" />
          ...
          <div className="relative px-8 py-16 sm:px-12 sm:py-20">
            ...
            <div className="ae-article-hero w-full rounded-xl overflow-hidden my-8" style={{ maxHeight: 440 }}>
              <img
                src="/blog/which-ai-assistant-is-best-for-finding-local-businesses.webp"
                alt="which ai assistant is best for finding local businesses"
