      ...
      <main className="min-h-screen bg-[#0F1117]">
        ...
        <article className="max-w-4xl mx-auto px-6 py-12 sm:py-16">
          <div className="prose prose-invert prose-lg max-w-none prose-headings:font-plus-jakarta prose-headings:text-white prose-p:text-gray-300 prose-a:text-[#FF6A00] prose-a:no-underline hover:prose-a:underline prose-strong:text-white">
            ...
            <p>The distinction matters for any business attempting to optimize for AI citation visibility. A brand that has invested in being cited by ChatGPT cannot assume the same playbook applies to Claude. Citation rates, source mix, and the structural traits of cited brands diverge in measurable ways across platforms, and the divergence is driven by how each model was trained to evaluate trustworthiness. Claude was trained using Constitutional AI, a method specific to Anthropic that produces a citation pattern with consistent fingerprints: narrower source mix, stronger institutional bias, heavier weighting of named expertise, and stricter accuracy filters than peer platforms.</p>
            ...
            <p>The filter has a corollary that brands often miss. Because Claude is conservative about citations, the brands it does cite gain a disproportionate trust signal in the eyes of users who notice which platforms cite them. A user who sees the same brand cited by Claude, ChatGPT, and Perplexity for the same query has a stronger trust association than a user who sees the brand cited by only one platform. Claude citations are scarcer but more compounding when earned, and that pattern shapes how Claude should fit into a multi-platform AEO strategy.</p>
            ...
            <p>The Claude trust filter is the practical residue of Constitutional AI applied to web search. Brands that consistently earn Claude citations share a set of observable characteristics that map directly to the training principles. Brands that consistently fail to earn Claude citations share a different and equally consistent set of traits. The pattern is not a mystery once you read enough Claude outputs side by side.</p>
            ...
            {/* CTA 4 */}
            <div className="ae-cta-inline not-prose">
              <p>We help brands identify the institutional publishers Claude already trusts for their category and build a structured earned-media program to compound that borrowed authority. Email us to start the conversation.</p>
            ...
            {/* CTA 5 */}
            <div className="ae-cta-inline not-prose">
              <p>Wondering whether your category is one where Claude visibility is actually achievable? We run a category-specific feasibility check as part of the Blind Spot Report so you do not waste effort on platforms where the structural odds are against you.</p>
            ...
            {/* CTA 8 */}
            <div className="ae-cta-inline not-prose">
              <p>We map your entity consensus footprint against category competitors and identify the specific publications where targeted earned media would have the highest Claude citation impact. The mapping is part of every Blind Spot Report.</p>
            ...
            <p>Identify the publications Claude already cites for queries in your category. Pursue earned coverage in those exact outlets through expert commentary, guest contributions, and source services. A mention in a publication Claude already trusts transfers authority faster than building independent authority from scratch. For more on how earned media compounds across platforms, see our analysis of <Link href="/blog/how-to-get-featured-in-google-ai-overviews">how to get featured in Google AI Overviews</Link>, which covers complementary techniques.</p>
            ...
            {/* CTA 9 */}
            <div className="ae-cta-inline not-prose">
              <p>We run the full Claude optimization playbook as a managed program for clients who want the results without managing the process. Start by understanding your current baseline.</p>
            ...
            <p>The first common cause is content drift on the original page: the previously cited page was updated in ways that reduced its accuracy or honesty signal — adding promotional language, removing primary source links during a redesign, or losing the named author byline in a CMS migration. The second cause is competitive content emergence: a newer, stronger source on the same topic has appeared and is now winning the citation slot. The third cause is recency decay: the originally cited page was current at the time of the first citation but has since aged into a stale window without a substantive update.</p>
            ...
            {/* CTA 10 */}
            <div className="ae-cta-inline not-prose">
              <p>Worried that you may be silently losing Claude citations you used to have? We run a recovery audit that traces specific citation losses to their cause and produces a remediation plan.</p>
          ...
          {/* CTA 11 */}
          <div className="ae-cta-inline not-prose">
            <p>We run the full Claude citation audit against your site as part of the Blind Spot Report and prioritize the gaps by projected citation impact.</p>
