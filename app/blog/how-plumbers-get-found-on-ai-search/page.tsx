    ...
    <>
      ...
      <header className="max-w-4xl mx-auto px-6 pt-10 pb-8">
        ...
        <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-[#1a1d27] to-[#0F1117] border border-white/5 h-56 flex items-center justify-center mb-8">
          <svg viewBox="0 0 1200 400" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Wrench */}
            <rect x="440" y="160" width="80" height="20" rx="4" fill="none" stroke="#FF6A00" strokeWidth="2" strokeOpacity="0.5" />
            <rect x="460" y="180" width="40" height="100" rx="4" fill="none" stroke="#FF6A00" strokeWidth="2" strokeOpacity="0.5" />
            <circle cx="480" cy="155" r="20" fill="none" stroke="#FF6A00" strokeWidth="2" strokeOpacity="0.6" />
            {/* AI response bubble */}
      ...
      <article className="max-w-4xl mx-auto px-6 py-4 prose prose-invert prose-lg max-w-none">
        ...
        <div className="ae-cta-inline not-prose">
          <p>Wondering if ChatGPT even knows your plumbing business exists? <Link href="/blindspot" className="text-[#FF6A00] hover:underline font-semibold">Get a free Blind Spot Report</Link> and find out in minutes.</p>
        </div>
        ...
        <div className="ae-cta-inline not-prose">
          <p>Is your emergency signal strong enough for AI to notice? <Link href="/blindspot" className="text-[#FF6A00] hover:underline font-semibold">Find out free</Link> before a competitor takes that call.</p>
        </div>
        ...
        <div className="ae-cta-inline not-prose">
          <p>Not sure which cities AI associates with your plumbing business? <Link href="/blindspot" className="text-[#FF6A00] hover:underline font-semibold">Get your free Blind Spot Report</Link> and see your full coverage map.</p>
        </div>
        ...
        <div className="ae-cta-inline not-prose">
          <p>Know exactly where your gaps are. <Link href="/blindspot" className="text-[#FF6A00] hover:underline font-semibold">Get your free Blind Spot Report</Link> and see the full picture in minutes.</p>
        </div>

        <div className="ae-callout ae-callout-info not-prose">
          <div className="ae-callout-title">Related Reading</div>
          <p>Plumbing is part of the broader home services category. See <Link href="/blog/how-contractors-and-home-service-companies-win-ai-search" className="text-[#FF6A00] hover:underline">how contractors win AI search</Link> for patterns that apply across trades, and <Link href="/blog/how-home-service-companies-dominate-ai-search" className="text-[#FF6A00] hover:underline">how home service companies dominate AI search</Link> for the full competitive picture.</p>
        </div>
