      ...
      <main className="min-h-screen bg-[#0F1117]">
        ...
        <article className="max-w-4xl mx-auto px-6 py-12 sm:py-16">
          <div className="prose prose-invert prose-lg max-w-none prose-headings:font-plus-jakarta prose-headings:text-white prose-p:text-gray-300 prose-a:text-[#FF6A00] prose-a:no-underline hover:prose-a:underline prose-strong:text-white">
            ...
            {/* CTA 2 */}
            <div className="ae-cta-inline not-prose">
              <p>We run platform scope diagnostics as part of every Blind Spot Report, testing the queries that actually matter to your business across all four major AI platforms in a single pass. Call us at <a href="tel:+12134442229" className="cta-inline">(213) 444-2229</a> today.</p>
            ...
            {/* CTA 4 */}
            <div className="ae-cta-inline not-prose">
              <p>Our off-page footprint audit maps the external signals supporting your AI citation authority and identifies specific erosion events that correlate with your citation loss timeline. Speak to an AEO specialist: <a href="tel:+12134442229" className="cta-inline">(213) 444-2229</a>.</p>
            ...
            {/* CTA 6 */}
            <div className="ae-cta-inline not-prose">
              <p>We map competitor entity consensus trajectories and identify how much ground needs to be made up and which specific authority-building moves would close the gap fastest. This analysis is included in every Blind Spot Report. Questions? Call <a href="tel:+12134442229" className="cta-inline">(213) 444-2229</a>.</p>
            ...
            {/* CTA 7 */}
            <div className="ae-cta-inline not-prose">
              <p>Recovery levers are only effective when matched to the correct diagnostic category. Our team identifies which levers apply to your situation and builds the recovery plan around your specific citation loss pattern. <a href="https://calendly.com/theanswerengine-support/30min" className="cta-inline">Book your free consultation here.</a></p>
            ...
            {/* CTA 8 */}
            <div className="ae-cta-inline not-prose">
              <p>Accurate diagnosis is the prerequisite for effective recovery. Our Blind Spot Report is designed specifically to produce that diagnosis across all five categories before any recovery investment is made. Reach us at <a href="tel:+12134442229" className="cta-inline">(213) 444-2229</a>.</p>
          ...
          <div className="prose prose-invert prose-lg max-w-none prose-headings:font-plus-jakarta prose-headings:text-white prose-p:text-gray-300 prose-a:text-[#FF6A00] prose-a:no-underline hover:prose-a:underline prose-strong:text-white">
            ...
            {/* CTA 10 */}
            <div className="ae-cta-inline not-prose">
              <p>The diagnostic work is where the recovery investment either compounds or gets wasted. Our team specializes in identifying which category applies before any remediation effort begins. Send your questions to <a href="mailto:support@theanswerengine.ai" className="cta-inline">support@theanswerengine.ai</a>.</p>
            ...
            <div className="ae-cta-block not-prose">
              ...
              <div className="ae-cta-tier-group">
                <div className="ae-cta-tier">
                  ...
                  <p>Blind Spot Report: citation presence across 4 platforms, platform scope diagnosis, root cause category identification. Call <a href="tel:+12134442229" className="cta-inline">(213) 444-2229</a> for a free consultation.</p>
                ...
                <div className="ae-cta-tier">
                  ...
                  <p>Send your domain and target queries and we will confirm whether we can identify a diagnostic category within 48 hours. <a href="https://calendly.com/theanswerengine-support/30min" className="cta-inline">Claim your market territory — one client per area.</a></p>
          ...
          <div className="ae-final-cta not-prose">
            <div className="ae-final-cta-inner">
              ...
              <p className="ae-final-cta-sub">The Blind Spot Report identifies which diagnostic category explains your citation loss, which platforms are affected, and what the recovery path looks like. It is the only starting point that avoids wasted recovery investment. <a href="tel:+12134442229" className="cta-inline">(213) 444-2229</a></p>
