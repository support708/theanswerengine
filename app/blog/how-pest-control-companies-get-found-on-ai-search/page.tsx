  ...
  return (
    <>
      ...
      <article className="max-w-4xl mx-auto px-6 py-4 prose prose-invert prose-lg max-w-none">
        ...
        <p>Pest control is unusual among home services because a meaningful share of its customers are not browsing. They are in crisis. A homeowner who discovers a wasp nest blocking the back door, finds evidence of rats in the attic, or wakes up to bedbugs is not in research mode. They want an answer immediately, and increasingly that means asking an AI assistant first.</p>
