      ...
      <nav className="max-w-4xl mx-auto px-6 pt-8 pb-0" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <div className="ae-article-hero w-full rounded-xl overflow-hidden mb-10" style={{ maxHeight: 420 }}>
            <img
              src="/blog/how-to-get-found-on-ai-for-near-me-searches.webp"
              alt="how to get found on ai for near me searches"
        ...
        <section id="website-signals" className="mb-14">
          ...
          <div className="ae-timeline mt-8 mb-8">
            <div className="ae-timeline-item">
              ...
              <div className="font-semibold text-[#F27D24]">City and service area in headline or subheadline</div>
            ...
            <div className="ae-timeline-item">
              ...
              <div className="font-semibold text-[#F27D24]">Geographic context woven into service descriptions</div>
            ...
            <div className="ae-timeline-item">
              ...
              <div className="font-semibold text-[#F27D24]">Local origin story and community ties</div>
            ...
            <div className="ae-timeline-item">
              ...
              <div className="font-semibold text-[#F27D24]">Full address or service area clearly stated</div>
            ...
            <div className="ae-timeline-item">
              ...
              <div className="font-semibold text-[#F27D24]">NAP (Name, Address, Phone) consistent across all pages</div>
