      ...
      <article className="max-w-4xl mx-auto px-6 pb-20">
        ...
        <div className="ae-author-card not-prose">
          ...
          <div>
            ...
            <div className="ae-author-bio">We help local service businesses get found, cited, and recommended by AI platforms. Our team tracks AI search trends daily so you do not have to.</div>
          </div>
        </div>
