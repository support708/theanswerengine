        ...
        <div className="max-w-4xl mx-auto px-6 py-20">
          ...
          >
            ...
            >
              ...
              <path d="M400 50 L450 80 L450 140 L400 170 L350 140 L350 80 Z" stroke="#FF6A00" strokeWidth="1" fill="none" opacity="0.3" />
              <path d="M400 70 L430 90 L430 130 L400 150 L370 130 L370 90 Z" stroke="#FF6A00" strokeWidth="0.5" fill="none" opacity="0.15" />
              <line x1="370" y1="108" x2="395" y2="128" stroke="#FF6A00" strokeWidth="1.5" opacity="0.3" />
              <line x1="395" y1="128" x2="430" y2="90" stroke="#FF6A00" strokeWidth="1.5" opacity="0.3" />
              {/* Signal waves */}
              <circle cx="600" cy="200" r="40" stroke="#FF6A00" strokeWidth="0.5" fill="none" opacity="0.1" />
              <circle cx="600" cy="200" r="70" stroke="#FF6A00" strokeWidth="0.5" fill="none" opacity="0.08" />
              <circle cx="600" cy="200" r="100" stroke="#FF6A00" strokeWidth="0.5" fill="none" opacity="0.06" />
              {/* Connection nodes */}
              <circle cx="150" cy="100" r="3" fill="#FF6A00" opacity="0.2" />
              <circle cx="250" cy="300" r="3" fill="#FF6A00" opacity="0.2" />
              <circle cx="700" cy="100" r="3" fill="#FF6A00" opacity="0.2" />
              <circle cx="650" cy="350" r="3" fill="#FF6A00" opacity="0.2" />
              <line x1="150" y1="100" x2="400" y2="110" stroke="#FF6A00" strokeWidth="0.5" opacity="0.08" />
              <line x1="250" y1="300" x2="400" y2="170" stroke="#FF6A00" strokeWidth="0.5" opacity="0.08" />
              <line x1="700" y1="100" x2="600" y2="200" stroke="#FF6A00" strokeWidth="0.5" opacity="0.08" />
              {/* Dots grid */}
          ...
          <article className="prose prose-invert prose-lg max-w-none prose-headings:font-plus-jakarta prose-headings:text-white prose-p:text-gray-300 prose-a:text-[#FF6A00] prose-a:no-underline hover:prose-a:underline prose-strong:text-white">
            ...
            <div className="not-prose">
              <div className="ae-cta-inline">
                <p>Which AI platforms are citing your competitors instead of you?</p>
                <Link href="/blindspot">Run a Free Competitor Comparison &rarr;</Link>
              </div>
            </div>
            ...
            <div className="not-prose">
              <div className="ae-cta-inline">
                <p>Skip the guesswork. See exactly what AI sees about your site.</p>
                <Link href="/blindspot">Get Your Free Blind Spot Report &rarr;</Link>
              </div>
            </div>
            ...
            <div className="not-prose">
              <div className="ae-cta-inline">
                <p>Prefer to talk through your AI trust strategy with a specialist?</p>
                <a href="tel:+12134442229">Call (213) 444-2229</a>
              </div>
            </div>
            ...
            <div className="not-prose">
              <div className="ae-cta-inline">
                <p>Send us your URL and we will run a quick trust signal check.</p>
                <a href="mailto:support@theanswerengine.ai">Email support@theanswerengine.ai</a>
              </div>
            </div>
          ...
          <div className="not-prose">
            <div className="ae-cta-block">
              <h3>Your Site Is Either Trusted or Invisible. Find Out Which.</h3>
              <p>
                Most businesses have trust signal gaps they cannot see. Our
                free Blind Spot Report audits your site across all the factors
                AI platforms evaluate and shows you exactly where to improve.
              </p>
          ...
          <div className="not-prose mb-8">
            <div className="ae-cta-inline">
              <p>Have questions about building AI trust for your site? We are here to help.</p>
              <a href="tel:+12134442229">Call (213) 444-2229</a>
            </div>
          </div>
          ...
          <div className="not-prose mb-8">
            <div className="ae-cta-inline">
              <p>Prefer to write? Send us your URL and we will run a trust check.</p>
              <a href="mailto:support@theanswerengine.ai">Email support@theanswerengine.ai</a>
            </div>
          </div>
          ...
          <div className="not-prose mb-8">
            <div className="ae-cta-inline">
              <p>Get the full picture. See every trust signal gap AI platforms can see.</p>
          ...
          <div className="not-prose mb-8">
            <div className="ae-cta-inline">
              <p>Ready to become the site AI trusts most in your industry?</p>
          ...
          <div className="not-prose">
            <div className="ae-final-cta">
              ...
              <p>
                Every day your site lacks the trust signals AI platforms
                evaluate, your competitors get cited and you do not. The gap
                compounds. Our free Blind Spot Report shows your current AI
                trust score and exactly where to improve. No pitch, just the
                data.
              </p>
