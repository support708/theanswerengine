        ...
        <article className="max-w-4xl mx-auto px-6 py-12 sm:py-16">
          ...
          <div className="mt-12 p-6 rounded-xl border border-gray-800 bg-gray-900">
            ...
            <ul className="space-y-3 text-gray-300">
              <li>
                <Link href="/blog/does-schema-markup-help-ai-search" className="text-[#FF6A00] hover:underline">Does Schema Markup Help AI Search?</Link> - How structured data indirectly influences ChatGPT citations
              </li>
              <li>
                <Link href="/blog/bing-places-chatgpt-connection" className="text-[#FF6A00] hover:underline">The Bing Places and ChatGPT Connection</Link> - How the Bing index feeds directly into AI recommendations
              </li>
              <li>
                <Link href="/blog/chatgpt-cant-see-google-business-profile" className="text-[#FF6A00] hover:underline">ChatGPT Can&apos;t See Your Google Business Profile</Link> - Why GBP data is invisible to AI platforms
              </li>
              <li>
                <Link href="/blog/how-chatgpt-chooses-businesses-to-recommend" className="text-[#FF6A00] hover:underline">How ChatGPT Chooses Businesses to Recommend</Link> - The citation signals that determine which businesses get named
              </li>
            </ul>
          </div>
          ...
          <div className="ae-author-card not-prose mt-12">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-[#FF6A00] flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                AE
              </div>
              <div>
