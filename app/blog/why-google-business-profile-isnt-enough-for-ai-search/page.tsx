    ...
    <nav className="text-sm text-gray-500 mb-8">
      ...
      <span className="text-gray-400">Business Pain Points</span>
          ...
          <div className="ae-article-hero w-full rounded-xl overflow-hidden mb-10" style={{ maxHeight: 420 }}>
            <img
              src="/blog/why-google-business-profile-isnt-enough-for-ai-search.svg"
              alt="why google business profile isnt enough for ai search"
        ...
        <article className="max-w-4xl mx-auto px-6 py-12 sm:py-16">
          <div className="prose prose-invert prose-lg max-w-none prose-headings:font-plus-jakarta prose-headings:text-white prose-p:text-gray-300 prose-a:text-[#FF6A00] prose-a:no-underline hover:prose-a:underline prose-strong:text-white">
            ...
            <div className="ae-callout ae-callout-warning not-prose">
              <p><strong>The transition is not symmetrical across platforms.</strong> Google AI Overviews still weight GBP signals in some local contexts. ChatGPT and Perplexity weight them far less. Claude weights them less still. A business that has optimized for the Google local pack is in a transitional position: still visible in some AI contexts, increasingly invisible in others, and trending toward broader invisibility as more recommendation traffic shifts to non-Google AI surfaces. The mitigation is not to abandon GBP but to extend the signal footprint beyond it. <a href="https://calendly.com/theanswerengine-support/30min" className="cta-inline">Claim your free call</a> before your market fills.</p>
            </div>
            ...
            <div className="ae-quote not-prose">
              <p><strong className="ae-named-thesis">The Retrieval Asymmetry:</strong> ChatGPT and Perplexity do not see Google&rsquo;s local pack. They see the open web. A business optimized only for Google&rsquo;s walled local graph is functionally invisible to retrieval systems that operate outside that graph. Ready to act? <a href="https://calendly.com/theanswerengine-support/30min" className="cta-inline">Book a free strategy session.</a></p>
            </div>
            ...
            <p>The most counterintuitive pattern AE auditors encounter in 2026 is the business with a flawless Google Business Profile — fully complete, hundreds of high-quality reviews, weekly Google posts, full category and service coverage, frequent photo uploads, and consistent local pack visibility — that nonetheless generates zero AI citations across ChatGPT, Perplexity, and Google AI Overviews for high-intent category queries in its service area. This is not a rare edge case. It is a common configuration, particularly for service businesses that have invested heavily in local SEO over the past five years and treated GBP optimization as the primary visibility lever. Check where you stand: <a href="https://theanswerengine.ai/blindspot" className="cta-inline">free Blind Spot Scan.</a></p>
          ...
          <div className="prose prose-invert prose-lg max-w-none prose-headings:font-plus-jakarta prose-headings:text-white prose-p:text-gray-300 prose-a:text-[#FF6A00] prose-a:no-underline hover:prose-a:underline prose-strong:text-white">
            ...
            <p>Yes — and this is one of the most common patterns the AE citation lab sees in audits. A business can have a 100% complete GBP, hundreds of reviews, weekly Google posts, and full category and service coverage, yet generate zero citations in ChatGPT, Perplexity, or Google AI Overviews for high-intent local queries. The reason is that GBP signal weight is largely contained within Google&rsquo;s local pack ecosystem and does not propagate to the broader AI retrieval graph. When the off-GBP footprint is empty, AI models have nothing to retrieve, score, or cite, no matter how strong the GBP is. <a href="https://calendly.com/theanswerengine-support/30min" className="cta-inline">Claim your market territory — one client per area.</a></p>
            ...
            <div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              ...
              <Link href="/blog/anatomy-of-an-ai-citation" className="group block p-6 rounded-xl bg-white/5 border border-white/10 hover:border-[#FF6A00]/40 transition-colors">
                ...
                <p className="text-sm text-gray-400">A line-by-line breakdown of what makes a single AI citation work, and how to engineer content for it. <a href="https://calendly.com/theanswerengine-support/30min" className="cta-inline">Book a free 30-minute strategy call.</a></p>
              </Link>
