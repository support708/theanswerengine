      ...
      <main className="min-h-screen bg-[#0F1117]">
        ...
        <article className="max-w-4xl mx-auto px-6 py-12 sm:py-16">
          <div className="prose prose-invert prose-lg max-w-none prose-headings:font-plus-jakarta prose-headings:text-white prose-p:text-gray-300 prose-a:text-[#FF6A00] prose-a:no-underline hover:prose-a:underline prose-strong:text-white">
            ...
            <p>An AI Overview synthesizes an answer from multiple sources and presents it as a structured, AI-generated response at the top of the SERP. Below the synthesized answer, small citation chips appear, each linking back to a source page that Google has determined is authoritative enough to support the answer. Those citation chips are the real prize. A brand cited inside an AIO receives both visibility and a click path from users who engaged with the AI answer and want to read more. Brands not cited are simply invisible at the top of the page.</p>
            ...
            <p>The shift is not temporary. Google has invested enormous infrastructure in AI Overview generation, the feature is expanding to more query types and more countries, and competitor AI search products from Perplexity and Microsoft have pushed Google to accelerate deployment. Businesses optimizing only for traditional organic ranking are now optimizing for the second-most visible position on the page. Understanding how AIO citation works is not optional for brands with meaningful search traffic at stake.</p>
            ...
            <div className="ae-cta-inline not-prose">
              <p>Find out whether your brand is currently being cited in Google AI Overviews, and which queries are triggering them for your category.</p>
            ...
            <p>For a foundational understanding of how AI platforms broadly decide which sources to cite, read our analysis of <Link href="/blog/how-ai-platforms-choose-businesses-to-cite">how AI platforms choose businesses to cite</Link>.</p>
            ...
            {/* CTA 5 */}
            <div className="ae-cta-inline not-prose">
              <p>Not sure which schema types your site is missing or implementing incorrectly? We cover schema in the Blind Spot Report.</p>
            ...
            {/* CTA 6 */}
            <div className="ae-cta-inline not-prose">
              <p>Struggling to build E-E-A-T signals on a new or thin-content domain? We map the fastest path to citation authority for your specific industry.</p>
            ...
            {/* CTA 8 */}
            <div className="ae-cta-inline not-prose">
              <p>Which content types on your site are closest to earning AIO citations? We identify priority pages in the Blind Spot Report.</p>
            ...
            {/* CTA 9 */}
            <div className="ae-cta-inline not-prose">
              <p>We run AIO visibility tracking as part of our ongoing client work. Ask us how we set up citation monitoring for your category.</p>
