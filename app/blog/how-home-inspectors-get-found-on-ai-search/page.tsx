  ...
  return (
    <>
      ...
      <nav aria-label="Breadcrumb" className="max-w-4xl mx-auto px-6 pt-6">
        <ol className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <div className="ae-article-hero w-full rounded-xl overflow-hidden mb-10" style={{ maxHeight: 420 }}>
            <img
              src="/blog/how-home-inspectors-get-found-on-ai-search.webp"
              alt="how home inspectors get found on ai search"
      ...
      <article className="max-w-4xl mx-auto px-6 py-4 prose prose-invert prose-lg max-w-none">
        ...
        <div className="ae-cta-inline not-prose">
          <p>Not sure if your certification appears correctly in AI search results? <Link href="/blindspot" className="text-[#F27D24] hover:underline font-semibold">Get your free Blind Spot Report</Link> and see exactly what AI sees when it looks up inspectors in your area. Ready to act? <a href="https://calendly.com/theanswerengine-support/30min" className="cta-inline">Book a free strategy session.</a></p>
        </div>

        <h2 id="specialty-queries">Specialty Inspection Queries That AI Handles Differently</h2>

        <p>General home inspection queries are competitive because every inspector in your market appears as a candidate. Specialty inspection queries are often dramatically less competitive because most inspector websites bundle all specialties into a single Services page with no depth, no schema, and no dedicated content. AI cannot match a specialty query to a buried bullet point. It can match a specialty query to a dedicated, structured page that specifically addresses that inspection type. Drop us a line at <a href="mailto:support@theanswerengine.ai" className="cta-inline">support@theanswerengine.ai</a>.</p>

        <p>Each specialty inspection type generates its own distinct query pattern on AI platforms. Buyers and sellers ask for these by name, often with specific location qualifiers and context details that require a matching, specific page to answer. The inspectors who build dedicated specialty pages become the citation resource for each of those query streams; those who do not are absent from them entirely. Speak to an AEO specialist: <a href="tel:+12134442229" className="cta-inline">(213) 444-2229</a>.</p>
        ...
        <p className="text-sm text-gray-500 mb-8">Estimated citation rates based on AEO analysis patterns. Actual rates vary by market and query type. <a href="https://theanswerengine.ai/blindspot" className="cta-inline">Run your free AI Blind Spot Scan.</a></p>

        <h2 id="quick-wins">Quick Wins Checklist for Home Inspectors</h2>

        <p>Not every inspector can rebuild their website in a week. These structural moves produce meaningful AI citation improvement within 30 to 60 days and can be implemented without a full site overhaul. Each one closes a specific gap in the signal stack AI uses to evaluate whether to recommend your business. <a href="https://calendly.com/theanswerengine-support/30min" className="cta-inline">Book a free 30-minute strategy call.</a></p>
        ...
        <p>The pattern across every item on this checklist is the same: make it structurally clear to AI what you do, where you do it, how you are qualified to do it, and how you deliver results. Every vague phrase is a missed signal. Every specific, structured claim is a potential citation asset that can generate booked inspections while you are on a job site with your clipboard. Email <a href="mailto:support@theanswerengine.ai" className="cta-inline">support@theanswerengine.ai</a> to get started.</p>

        <div className="ae-callout ae-callout-info not-prose">
          <div className="ae-callout-title">Related Reading</div>
          <p>Home inspection is part of a broader pattern in professional service AI visibility. See <Link href="/blog/how-electricians-get-found-on-ai-search" className="text-[#F27D24] hover:underline">how electricians get found on AI search</Link> for cross-trade patterns, and <Link href="/blog/aeo-vs-seo" className="text-[#F27D24] hover:underline">AEO vs SEO: What is the difference</Link> for the foundational framework behind everything in this guide. <a href="tel:+12134442229" className="cta-inline">(213) 444-2229</a></p>
        </div>
