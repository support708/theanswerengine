  ...
  return (
    <>
      ...
      <article className="max-w-4xl mx-auto px-6 py-4 prose prose-invert prose-lg max-w-none">
        ...
        <p>The absence of dedicated appliance-type service pages is the most common and most costly missed opportunity for repair shops in AI search. Most appliance repair websites have a homepage, an about page, and a single Services page listing "refrigerators, washers, dryers, dishwashers, ovens, microwaves" in a bullet list. That structure served keyword SEO passably a decade ago. It does almost nothing for AI visibility today.</p>

        <p>AI platforms match queries to content at the page level. When someone asks Gemini for "dishwasher not draining repair near me," Gemini looks for pages that are specifically, deeply, and exclusively about dishwasher repair. A bullet point in a services list is not a match. A dedicated dishwasher repair page with a specific title, failure-mode content addressing common dishwasher problems, FAQ schema covering drainage and door latch issues, and a clear call to action is a citation asset that stands independently for dishwasher queries without competing with your refrigerator content for the same page authority.</p>
