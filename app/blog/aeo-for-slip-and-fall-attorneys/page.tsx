      ...
      <div className="min-h-screen bg-[#131313] text-[#e5e2e1]">
        <article className="max-w-4xl mx-auto px-6 pt-24 pb-16">
          ...
          <div className="ae-article-body prose prose-invert prose-lg max-w-none">
            ...
            <p>
              AEO diverges from SEO at the retrieval layer, not the keyword layer. SEO rewards backlink authority, on-page keyword targeting, and Core Web Vitals. AEO rewards bounded-claim chunks, named-expert authorship, schema density, and hazard-specific review signals that LLM retrievers parse as trust evidence. A premises firm at Google position 1 may receive no Perplexity citation on the same query because Perplexity weights recency and content depth over accumulated domain authority. Conversely, a small slip and fall practice that publishes statute-locked Q&amp;A pages on notice doctrine can outrank a national firm on Perplexity inside 60 days. Answer Engine Optimization is a separate discipline because the ranking mechanic is fundamentally different.
