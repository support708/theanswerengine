      ...
      <main className="min-h-screen bg-[#0F1117]">
        ...
        <section className="relative overflow-hidden border-b border-white/5">
          ...
          <svg className="absolute inset-0 w-full h-full opacity-[0.03]" aria-hidden="true">
            <defs>
              <pattern id="hero-grid-barbershop" width="40" height="40" patternUnits="userSpaceOnUse">
                <path d="M 40 0 L 0 0 0 40" fill="none" stroke="white" strokeWidth="0.5" />
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#hero-grid-barbershop)" />
          </svg>
        ...
        <article className="max-w-4xl mx-auto px-6 py-12 sm:py-16">
          ...
          <div className="not-prose my-16 p-8 rounded-2xl bg-gradient-to-br from-[#FF6A00]/10 to-transparent border border-[#FF6A00]/20">
            <h3 className="font-plus-jakarta text-2xl font-bold text-white mb-3">
              Is Your Barbershop Invisible When Customers Ask AI?
            </h3>
            <p className="text-gray-400 mb-6">
              Most barbershops have no idea what AI says about them. Find out what&apos;s keeping you
              out of AI recommendations with a free Blind Spot Report.
            </p>
            <Link
              href="/blindspot"
