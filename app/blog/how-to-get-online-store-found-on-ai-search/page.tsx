            ...
            <div className="relative rounded-2xl overflow-hidden mb-8 bg-[#0F1117] border border-white/[0.06]" style={{ minHeight: '180px' }}>
              ...
              <div className="relative z-10 flex flex-col items-start justify-center p-8 sm:p-12" style={{ minHeight: '180px' }}>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#FF6A00]/10 border border-[#FF6A00]/30 mb-4">
                  ...
                  <span className="text-xs font-bold tracking-widest uppercase text-[#FF6A00]">How-To Guides</span>
                </div>
            ...
            <div className="ae-author-card not-prose">
              ...
              <div className="ae-author-info">
                ...
                <div className="ae-author-bio">
                  We are an Answer Engine Optimization agency helping businesses become visible to ChatGPT, Perplexity, Google AI Mode, and every major AI platform. We audit e-commerce stores across Shopify, WooCommerce, and custom platforms, and we know exactly what AI shopping assistants look for when deciding which products to recommend.
                </div>
              </div>
            </div>
